...
function create_and_push_manifest() {
  ...
  docker manifest create $NAME:$TAG \
    ...
    --amend "$NAME:$LIBRESPOT_VERSION-arm64v8" 
...
build_and_push_image "Dockerfile.template" "${DOCKER_NAMESPACE}/librespot:$LIBRESPOT_VERSION-arm64v8" "arm64v8" "linux/arm64" "$LIBRESPOT_VERSION"
...
create_and_push_manifest "szredor/librespot" "$LIBRESPOT_VERSION"
